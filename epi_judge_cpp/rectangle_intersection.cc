...
Rect IntersectRectangle(const Rect& r1, const Rect& r2) {
    if (not (r1.x <= r2.x + r2.width && r1.x + r1.width >= r2.x &&
        r1.y <= r2.y + r2.height && r1.y + r1.height >= r2.y)) {
        return { 0, 0, -1, -1 };
    }

    int x = fmax(r1.x, r2.x);
    int y = fmax(r1.y, r2.y);
    int width = fmin(r1.x + r1.width, r2.x + r2.width) - fmax(r1.x, r2.x);
    int height = fmin(r1.y + r1.height, r2.y + r2.height) - fmax(r1.y, r2.y);
